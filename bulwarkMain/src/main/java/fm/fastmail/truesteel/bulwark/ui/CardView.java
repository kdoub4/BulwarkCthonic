...
import fm.fastmail.truesteel.bulwark.util.CheckableEx;
 ...
 */
	...
	public void setCard(MyCard c) {
        ...
        countLeft.setTextColor(textColor);
	...
	public boolean onLongClick(View view) {
		...
		String englishName;
		try {
			englishName = this.getContext().createConfigurationContext(configuration).getResources().getString(this.getContext().createConfigurationContext(configuration).getResources().getIdentifier(cardView.getCard().originalSafeName + "_name", "string", this.getContext().getPackageName()));
		}
		catch (Exception e) {
			englishName = cardView.getCard().originalSafeName;
		}
		if (wikilink) {
