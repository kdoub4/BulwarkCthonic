...
public class Achievements {
    ...
    public boolean hasAchieved(String achievement) {
        ...
        if(index == -1) {
            Log.d("Bulwark","ERROR: Requested Achievement not found:" + achievement);
            return false;
        }
    ...
    public boolean hasAchieved(int index) {
        if(index < 0 || index >= KEYS.length) {
            Log.d("Bulwark","ERROR: Requested Achievement not found:" + index);
            return false;
        }
    ...
    public void achieved(String achievement) {
        int index = achievementIndex(achievement);
        if(index == -1) {
            Log.d("Bulwark","ERROR: Acquired Achievement not found:" + achievement);
            return;
        }
