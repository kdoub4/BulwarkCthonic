...
import fm.fastmail.truesteel.bulwark.fragments.StartGameFragment;
import fm.fastmail.truesteel.bulwark.fragments.StartGameFragment.OnStartGameListener;
...
OnStartGameListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Fix so Bulwark doesn't crash when updating
        SharedPreferences pref = PreferenceManager
                .getDefaultSharedPreferences(this);
        Log.d(TAG,
              "Theme is set to "
              + pref.getString("theme", "bulwark-dark"));
        if (pref.getString("theme", getString(R.string.pref_theme_default)).equals("bulwark")) {
            // Settings from previous Bulwark version exist
