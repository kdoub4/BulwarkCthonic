...
//-add to Kind
    ...
    static {
        ...
        heroismCards.add(one = new CardImpl.Builder(Cards.Kind.One, 0, Type.Treasure).setPileSize(7).addHeroism(1).build());
        heroismCards.add(two = new CardImpl.Builder(Cards.Kind.Two, 2, Type.Hero, Type.Treasure).addHeroism(2).build());
        heroismCards.add(three = new CardImpl.Builder(Cards.Kind.Three, 2, Type.Hero, Type.Treasure).addHeroism(3).addBuys(1).upgradeCard(Kind.Two).build());

        nonKingdomCards.add(platinum = new CardImpl.Builder(Cards.Kind.Platinum, 9, Type.Treasure).addHeroism(5).build());
        nonKingdomCards.add(gold = new CardImpl.Builder(Cards.Kind.Gold, 6, Type.Treasure).addHeroism(3).build());
        nonKingdomCards.add(silver = new CardImpl.Builder(Cards.Kind.Silver, 3, Type.Treasure).addHeroism(2).build());
        nonKingdomCards.add(copper = new CardImpl.Builder(Cards.Kind.Copper, 0, Type.Treasure).addHeroism(1).build());
        ...
        // Arpad
        shieldCardsArpad.add(shield = new CardImpl.Builder(Kind.Shield, 2, Type.Hero, Type.Action, Type.Defend, Type.Equipment, Type.InHandReaction).addCards(1).description("Put a card from hand on top of your deck. Reaction: Discard this to defend any player.").expansion(Expansion.Base).build());
        shieldCardsArpad.add(towerShield = new CardImpl.Builder(Kind.TowerShield, 1, Type.Hero, Type.Action, Type.Defend, Type.Equipment, Type.Remains, Type.RemainsReaction).addCards(2).upgradeCard(Kind.Shield).description("Put 2 cards from hand on top of your deck. Reaction: Discard this to defend any player.").expansion(Expansion.Base).build());
        swordCardsArpad.add(mastersSword = new CardImpl.Builder(Kind.MastersSword, 4, Type.Hero, Type.Action,Type.Equipment, Type.Attack).addCards(1).addActions(2).setAttacks(1).expansion(Expansion.Base).build());
        swordCardsArpad.add(bloodstainedBlade = new CardImpl.Builder(Kind.BloodstainedBlade, 2, Type.Hero, Type.Action, Type.Equipment, Type.Attack).addActions(2).addCards(1).setAttacks(1).setMight(2).upgradeCard(Kind.MastersSword).expansion(Expansion.Base).build());
        swordCardsArpad.add(hundredScimitar = new CardImpl.Builder(Kind.HundredScimitar, 1, Type.Hero, Type.Action,Type.Equipment, Type.Attack).addActions(2).addCards(2).setAttacks(1).setMight(2).upgradeCard(Kind.BloodstainedBlade).expansion(Expansion.Base).build());
        heroCardsArpad.add(attack = new CardImpl.Builder(Kind.Attack, 0, Type.Hero, Type.Action, Type.Attack).setPileSize(2).addCards(1).addActions(1).setAttacks(1).description("Put a card from hand on top of your deck").expansion(Expansion.Base).build());
        heroCardsArpad.add(virtualShield = new CardImpl.Builder(Kind.VirtualShield, 2, Type.Hero, Type.Action, Type.InHandReaction).pileCreator(new ArpadShieldPileCreator()).expansion(Expansion.Base).build());
        heroCardsArpad.add(virtualSword = new CardImpl.Builder(Kind.VirtualSword, 4, Type.Hero, Type.Action, Type.Attack).pileCreator(new ArpadSwordPileCreator()).expansion(Expansion.Base).build());
        heroCardsArpad.add(lamellarArmour = new CardImpl.Builder(Kind.LamellarArmour, 3, Type.Hero, Type.Action, Type.Equipment, Type.InHandReaction).setPileSize(4).addCards(2).description("Reaction: When you put this card on top of your draw deck, you may Trash 1.").expansion(Expansion.Base).build());
        heroCardsArpad.add(charge = new CardImpl.Builder(Cards.Kind.Charge, 5, Type.Hero, Type.Action, Type.InHandReaction, Type.OnAttack, Type.Technique).setPileSize(3).addCards(2).setActions(0).setMight(2).description("You may not play any more actions, Might 2.  Reaction: When another player attacks, Banish this to give them Might 2").expansion(Expansion.Base).build());
        heroCardsArpad.add(virtualHeroism = new CardImpl.Builder(Kind.VirtualHeroism, 2, Type.Hero, Type.Treasure).pileCreator(new HeroismPileCreator()).expansion(Expansion.Base).build());
        heroCardsArpad.add(one);

        //Wiola
        heroCardsWiola.add(stalk = new CardImpl.Builder(Kind.Stalk, 0, Type.Hero, Type.Action).setPileSize(1).addActions(2).description("Reveal the top card of your deck, discard it or return it.").expansion(Expansion.Base).build());
        shotCardsWiola.add(pinpointShot = new CardImpl.Builder(Kind.PinpointShot, 3, Type.Hero, Type.Action, Type.Technique, Type.Remains, Type.RemainsReaction, Type.OnAttack).addActions(1).description("While Remaining: Reaction: When you make an attack, Banish this for +1 Might.").expansion(Expansion.Base).build());
        shotCardsWiola.add(comtempuousShot = new CardImpl.Builder(Kind.ContempuousShot, 0, Type.Hero, Type.Action,Type.Technique, Type.Remains, Type.RemainsReaction, Type.OnActivation, Type.OnAttack).addActions(1).upgradeCard(Kind.PinpointShot).description("While Remaining: Reaction: When you attack, Discard this for +1 Might.  Reaction: Trash this to prevent a Foe from activating.").expansion(Expansion.Base).build());
        bowCardsWiola.add(longbow = new CardImpl.Builder(Kind.Longbow, 4, Type.Hero, Type.Action, Type.Equipment, Type.Attack, Type.Range).addActions(1).addCards(1).setAttacks(1).expansion(Expansion.Base).build());
        bowCardsWiola.add(prestigeBow = new CardImpl.Builder(Kind.PrestigeBow, 2, Type.Hero, Type.Action,Type.Equipment, Type.Attack, Type.Range).addActions(1).addCards(1).setAttacks(1).upgradeCard(Kind.Longbow).description("Get Might 2 if you have already played a bow this turn.").expansion(Expansion.Base).build());
        bowCardsWiola.add(enchantedBow= new CardImpl.Builder(Kind.EnchangtedBow, 2, Type.Hero, Type.Action, Type.Attack, Type.Equipment, Type.Range).addActions(1).addCards(1).setAttacks(1).upgradeCard(Kind.PrestigeBow).description("Get Might 2 if you have already played a a bow this turn. You may discard any number of cards to draw the same number of cards.").expansion(Expansion.Base).build());
        heroCardsWiola.add(virtualShot = new CardImpl.Builder(Kind.VirtualShot, 3, Type.Hero, Type.Action, Type.Technique).pileCreator(new WiolaShotPileCreator()).expansion(Expansion.Base).build());
        heroCardsWiola.add(virtualBowW = new CardImpl.Builder(Kind.VirtualBow, 4, Type.Hero, Type.Action, Type.Attack, Type.Range, Type.Equipment).pileCreator(new WiolaBowPileCreator()).expansion(Expansion.Base).build());
        heroCardsWiola.add(vantagePoint = new CardImpl.Builder(Kind.VantagePoint, 5, Type.Hero, Type.Action, Type.Remains).setPileSize(2).description("While Remaining: You are Invincible as long as there are more than 10 Foes. Discard this at the end of a turn where you make a Melee attack. When in Hand: Reaction: When another player makes an attack, Banish this to give them +1 Might.").expansion(Expansion.Base).build());
        heroCardsWiola.add(shoot = new CardImpl.Builder(Kind.Shoot, 0, Type.Action, Type.Hero, Type.Range ).setAttacks(1).setPileSize(2).addCards(1).expansion(Expansion.Base).build());
        heroCardsWiola.add(patientHunter = new CardImpl.Builder(Kind.PatientHunter, 2, Type.Hero, Type.Action).setPileSize(4).addActions(2).description("Hunt for a bow or a shot.").expansion(Expansion.Base).build());
        heroCardsWiola.add(virtualHeroism = new CardImpl.Builder(Kind.VirtualHeroism, 2, Type.Hero, Type.Treasure).pileCreator(new HeroismPileCreator()).expansion(Expansion.Base).build());
        heroCardsWiola.add(one);

        //ZsuZsa
        heroCardsZsuzsa.add(sidestep = new CardImpl.Builder(Kind.Sidestep, 0, Type.Hero, Type.Action).setPileSize(2).description("+2 Actions or +1 Card.").expansion(Expansion.Base).build());
        bowCardsZsuzsa.add(shortbow = new CardImpl.Builder(Kind.Shortbow, 2, Type.Hero, Type.Action, Type.Equipment, Type.Range).setAttacks(1).addCards(1).description("Reaction: During the Attack step of another player, Discard this to give them Range..").expansion(Expansion.Base).build()); //TODO Bulwark multiplayer
        bowCardsZsuzsa.add(crossbow = new CardImpl.Builder(Kind.Crossbow, 2, Type.Hero, Type.Action,Type.Equipment, Type.Attack, Type.Range).setAttacks(1).addCards(2).upgradeCard(Kind.Shortbow).description("Reaction: During the Attack step of another player, Discard this to give them Range..").expansion(Expansion.Base).build()); //TODO Bulwark multiplayer
        daggerCardsZsuzsa.add(dualDaggers = new CardImpl.Builder(Kind.DualDaggers, 3, Type.Hero, Type.Action, Type.Equipment, Type.Attack).addActions(1).addCards(1).setAttacks(1).expansion(Expansion.Base).build());
        daggerCardsZsuzsa.add(nightDaggers = new CardImpl.Builder(Kind.NightDaggers, 1, Type.Hero, Type.Action,Type.Equipment, Type.Attack).addActions(1).addCards(1).setAttacks(2).upgradeCard(Kind.DualDaggers).description("You may attack twice.").expansion(Expansion.Base).build());
        daggerCardsZsuzsa.add(burialDaggers= new CardImpl.Builder(Kind.BurialDaggers, 1, Type.Hero, Type.Action, Type.Attack, Type.Equipment).addActions(1).addCards(2).setAttacks(2).upgradeCard(Kind.NightDaggers).description("You may attack twice.").expansion(Expansion.Base).build());
        heroCardsZsuzsa.add(virtualDaggers = new CardImpl.Builder(Kind.VirtualDaggers, 3, Type.Hero, Type.Action, Type.Equipment).pileCreator(new ZsuzsaDaggerPileCreator()).expansion(Expansion.Base).build());
        heroCardsZsuzsa.add(virtualBowZ = new CardImpl.Builder(Kind.VirtualBow, 2, Type.Hero, Type.Action, Type.Attack, Type.Range, Type.Equipment).pileCreator(new ZsuzsaBowPileCreator()).expansion(Expansion.Base).build());
        heroCardsZsuzsa.add(flankAttack = new CardImpl.Builder(Kind.FlankAttack, 4, Type.Hero, Type.Action, Type.Remains, Type.RemainsReaction, Type.OnAttack, Type.Technique).setPileSize(4).description("While Remaining: The next other player to attack gets +1 Might, discard this.").expansion(Expansion.Base).build());
        heroCardsZsuzsa.add(knifeInTheBack= new CardImpl.Builder(Kind.KnifeInTheBack, 0, Type.Action, Type.Hero, Type.Attack ).setAttacks(1).setPileSize(1).addCards(1).expansion(Expansion.Base).build());
        //Sneak should be turnend
        heroCardsZsuzsa.add(sneak = new CardImpl.Builder(Kind.Sneak, 5, Type.Hero, Type.Action, Type.InHandManoeuvre, Type.Defend).setPileSize(4).addActions(2).setMight(2).description("Manoeuvre: Banish this to be Invincible for one turn.").expansion(Expansion.Base).build());
        heroCardsZsuzsa.add(virtualHeroism = new CardImpl.Builder(Kind.VirtualHeroism, 2, Type.Hero, Type.Treasure).pileCreator(new HeroismPileCreator()).expansion(Expansion.Base).build());
        heroCardsZsuzsa.add(theDrop= new CardImpl.Builder(Kind.TheDrop, 4, Type.Action, Type.Hero, Type.Remains, Type.RemainsReaction, Type.OnAttack, Type.WhenDrawn, Type.Technique).addCards(1).setPileSize(5).addActions(1).description("While Remaining: Reaction: When you Draw a Foe, Trash this to Banish it, ignoring When Drawn and Flyby abilities.  Reaction: Trash this, Trash 1 for +1 Might.").expansion(Expansion.Base).build());
        heroCardsZsuzsa.add(one);

        //Sandor
        staffCardsSandor.add(oakStaff= new CardImpl.Builder(Kind.OakStaff, 3, Type.Hero, Type.Action, Type.Attack, Type.Equipment).setAttacks(1).description("+2 Actions or +2 Cards.").expansion(Expansion.Base).build());
        staffCardsSandor.add(carvedStaff= new CardImpl.Builder(Kind.CarvedStaff, 0, Type.Hero, Type.Action, Type.Attack, Type.Range, Type.Equipment).setAttacks(1).upgradeCard(Kind.OakStaff).description("+2 Actions or +2 Cards.").expansion(Expansion.Base).build());
        staffCardsSandor.add(ironShodStaff= new CardImpl.Builder(Kind.IronShodStaff, 1, Type.Hero, Type.Action,Type.Equipment, Type.Attack, Type.Range).setAttacks(1).upgradeCard(Kind.CarvedStaff).description("+2 Actions or +2 Cards. You may take X Wounds for +X Might.").expansion(Expansion.Base).build());
        heroCardsSandor.add(virtualStaff = new CardImpl.Builder(Kind.VirtualStaff, 3, Type.Hero, Type.Action, Type.Attack, Type.Equipment).pileCreator(new SandorStaffPileCreator()).expansion(Expansion.Base).build());
        heroCardsSandor.add(sanctusCharm= new CardImpl.Builder(Kind.SanctusCharm, 4, Type.Hero, Type.Action, Type.InHandManoeuvre, Type.Defend).setPileSize(3).addActions(2).addCards(1).description("Another player may draw a card.  Manoeuvre: Discard this, you take at most 1 Wound this turn.").expansion(Expansion.Base).build());
        heroCardsSandor.add(prayer  = new CardImpl.Builder(Kind.Prayer, 5, Type.Hero, Type.Action,Type.Remains, Type.RemainsManoeuvre, Type.Technique).setPileSize(4).addActions(1).callWhenActionResolved().description("Remains.  While Remaining : Any player may discard this at any time for +2 Cards. If it was not thier turn, Banish this.").expansion(Expansion.Base).build());
        heroCardsSandor.add(bless = new CardImpl.Builder(Kind.Bless, 0, Type.Hero, Type.Action).setPileSize(2).description("Pick another player, they may Discard 1 for +1 Card.").expansion(Expansion.Base).build());
        heroCardsSandor.add(beat = new CardImpl.Builder(Kind.Beat, 0, Type.Hero, Type.Action, Type.Attack).setAttacks(1).setPileSize(1).addActions(2).expansion(Expansion.Base).build());
        healingCardsSandor.add(healingHerbs= new CardImpl.Builder(Kind.HealingHerbs, 2, Type.Hero, Type.Action, Type.Equipment).addCards(1).description("Every player may Trash 1.").expansion(Expansion.Base).build());
        healingCardsSandor.add(healingBalm= new CardImpl.Builder(Kind.HealingBalm, 2, Type.Hero, Type.Action, Type.Equipment).upgradeCard(Kind.HealingHerbs).addCards(1).description("A player reveals 5 cards from their deck, Banish all Wounds revealed and Discard the rest.").expansion(Expansion.Base).build());
        heroCardsSandor.add(virtualHealing = new CardImpl.Builder(Kind.VirtualHealing, 2, Type.Hero, Type.Action, Type.Equipment).pileCreator(new SandorHealingPileCreator()).expansion(Expansion.Base).build());
        heroCardsSandor.add(virtualHeroism = new CardImpl.Builder(Kind.VirtualHeroism, 2, Type.Hero, Type.Treasure).pileCreator(new HeroismPileCreator()).expansion(Expansion.Base).build());
        heroCardsSandor.add(orison = new CardImpl.Builder(Kind.Orison, 0, Type.Hero, Type.Action, Type.Remains, Type.RemainsReaction).callWhenTurnStarts().setPileSize(2).description("While Remaining: Reaction: At the start of your turn, you may Discard this for +1 Card.").expansion(Expansion.Base).build());
        heroCardsSandor.add(one);

        cardsGoblin.add(goblinTroop = new CardImpl.Builder(Kind.GoblinTroop, 1, Type.Enemy).build());
        cardsGoblin.add(goblinAlchemist = new CardImpl.Builder(Kind.GoblinAlchemist, 2, Type.Enemy, Type.Activate).description("Activate: If adjacent to an alchemist of a blast, take 2 Wounds.").build());
        cardsGoblin.add(goblinRabble = new CardImpl.Builder(Kind.GoblinRabble, 1, Type.Enemy, Type.WhenDrawn).description("When Drawn: Banish 2 Foes, draw 2 Foes, ignore the 'When Drawn' text of any Rabbles thus drawn.").build());
        cardsGoblin.add(catapultBulwark= new CardImpl.Builder(Kind.GobCatapult, 2, Type.Enemy, Type.Activate, Type.Range, Type.Blast).description("Activate: Each player discards the top card of their deck. If it was a Wound, they take a Wound.").build());
        cardsGoblin.add(goblinHeavy = new CardImpl.Builder(Kind.GoblinHeavy, 2, Type.Enemy,Type.Activate).description("Activate: Take a Wound if a troop is in play.").build());
        cardsGoblin.add(goblinArcher = new CardImpl.Builder(Kind.GoblinArcher, 1, Type.Enemy, Type.Activate, Type.Range).description("Activate: If there are 2 or more archers in play, take a Wound.").build());
        cardsGoblin.add(kneena = new CardImpl.Builder(Kind.KneenaGoblin, 2, Type.Enemy, Type.Crown, Type.Activate, Type.Range).description("The Goblin Druid - Activate: Each player discards the top card of their deck. If it was a Location card, they take a Wound.").build());
        cardsGoblin.add(kmblee = new CardImpl.Builder(Kind.KmbleeGoblin, 2, Type.Enemy, Type.Crown, Type.Activate).description("The Goblin Scout - Activate: Draw a foe.").build());
        cardsGoblin.add(kmron = new CardImpl.Builder(Kind.KmronGoblin, 3, Type.Enemy, Type.Crown, Type.Activate).description("The Goblin Chief - Activate: Take a Wound.").build());
        cardsGoblin.add(ghutz = new CardImpl.Builder(Kind.GhutzGoblin, 1, Type.Enemy, Type.Crown, Type.Activate).description("The Goblin Berserker - Activate: Take a Wound for each Goblin in play.").build());
        cardsGoblin.add(mgzwel = new CardImpl.Builder(Kind.MgzwelGoblin, 2, Type.Enemy, Type.Crown).description("The Goblin Armourer - While in Play: Goblins up to 2 spaces away get +1 Armour. MgzwelGoblin does not increase his own Armour.").build());
        //cardsGoblinHorde.add(virtualEnemy = new CardImpl.Builder(Kind.VirtualEnemy, 3, Type.Enemy).pileCreator(new GoblinPileCreator()).expansion(Expansion.Base).build());

        cardsLizard.add(lizardTroop = new CardImpl.Builder(Kind.LizardTroop, 1, Type.Enemy).description("+1 Armour if adjacent to a Heavy.").build());
        cardsLizard.add(fireCatapult = new CardImpl.Builder(Kind.FireCatapult, 2, Type.Enemy, Type.Activate, Type.Blast, Type.Range).description("Activate: Reveal your hand. If a Wound is revealed or you have a Wound underneath a card Remaining in play, take a Wound.").build());
        cardsLizard.add(lizardRabble = new CardImpl.Builder(Kind.LizardRabble, 1, Type.Enemy, Type.Activate).description("Activate: Kill this, draw a Foe.").build());
        cardsLizard.add(batteringRam= new CardImpl.Builder(Kind.BatteringRam, 2, Type.Enemy, Type.Activate, Type.Blast).description("Activate: Take a Wound for each Blast activation there has already been this turn..").build());
        cardsLizard.add(lizardHeavy = new CardImpl.Builder(Kind.LizardHeavy, 2, Type.Enemy,Type.Activate).description("Activate: Take a Wound for each adjacent troop.").build());
        cardsLizard.add(lizardBombardier = new CardImpl.Builder(Kind.LizardBombardier, 1, Type.Enemy, Type.Activate).description("Activate: Discard a card you have Remaining in play.").build());
        cardsLizard.add(giantCorpseHound= new CardImpl.Builder(Kind.GiantCorpseHound, 2, Type.Enemy, Type.Crown, Type.Undead).description("The current player takes a Wound every time a Foe other than a corpse hound is killed.").build());
        cardsLizard.add(kyung = new CardImpl.Builder(Kind.KyungLizard, 2, Type.Enemy, Type.Crown, Type.Range).description("The Lizard Mystic - You cannot buy Hero cards").build());
        cardsLizard.add(yoonIseul = new CardImpl.Builder(Kind.YoonIseulLizard, 3, Type.Enemy, Type.Crown, Type.Activate, Type.Horseman).description("The Lizard Queen - Activate: Activate the Foe before her, then activate the Foe after her. She cannot be activated more than once a turn.").build());
        cardsLizard.add(sang = new CardImpl.Builder(Kind.SangLizard, 2, Type.Enemy, Type.Crown).description("The Lizard Alchemist - Blast are Invincible.").build());
        cardsLizard.add(hyeon = new CardImpl.Builder(Kind.HyeonLizard, 3, Type.Enemy, Type.Crown, Type.Activate).description("The Lizard Champion - Activate : If you did not kill a Foe this turn, take 2 Wounds").build());
        //cardsLizardCrusade.add(virtualEnemy = new CardImpl.Builder(Kind.VirtualEnemy, 3, Type.Enemy).pileCreator(new LizardPileCreator()).expansion(Expansion.Base).build());

        cardsElf.add(elfTroop = new CardImpl.Builder(Kind.ElfTroop, 1, Type.Enemy, Type.Activate).description("If there are 4 or more Elves in play, take a Wound").build());
        cardsElf.add(flameBallista = new CardImpl.Builder(Kind.FlameBallista, 1, Type.Enemy, Type.Activate, Type.Blast, Type.Range).description("Activate: Take a Wound in hand for each card you have Remaining in play.").build());
        cardsElf.add(elfRabble = new CardImpl.Builder(Kind.ElfRabble, 1, Type.Enemy, Type.WhenDrawn).description("When Drawn: Banish a non rabble Foe.  While In Play: Counts of 2 Elves.").build());
        cardsElf.add(elfDruid = new CardImpl.Builder(Kind.ElfDruid, 2, Type.Enemy, Type.Activate, Type.Range).description("Activate: Discard the top 2 cards of your deck, take a Wound for each Location card revealed.").build());
        cardsElf.add(corpseVine = new CardImpl.Builder(Kind.CorpseVine, 1, Type.Enemy).description("While In Play: You cannot buy Location cards.").build());
        cardsElf.add(elfArcher = new CardImpl.Builder(Kind.ElfArcher, 1, Type.Enemy, Type.Activate, Type.Range).description("Activate: If there are 2 or more archers in play, take a Wound for each elf in play, up to a maximum of 3.").build());
        cardsElf.add(kiri= new CardImpl.Builder(Kind.KiriElf, 2, Type.Enemy, Type.Crown, Type.Activate, Type.Undead, Type.Range, Type.Necromancer).description("The Elf Necromancer - Activate: Take a Wound for each corpse in play.  When Killed: Resurrect 2, elves or corpses.").build());
        cardsElf.add(ruiha = new CardImpl.Builder(Kind.RuihaElf, 4, Type.Enemy, Type.Crown, Type.Activate, Type.Horseman).description("The Fallen Elf - Activate: Take a Wound.  While In Play: Adjacent elves and demons are invincible.  When Killed: Draw 2 Foes.").build());
        cardsElf.add(tane = new CardImpl.Builder(Kind.TaneElf, 2, Type.Enemy, Type.Crown, Type.Activate, Type.Horseman).description("The Elf Lancer - Activate: If there is a Foe on both sides of him, take 2 Wounds.").build());
        cardsElf.add(vepor = new CardImpl.Builder(Kind.VeporDemon, 2, Type.Enemy, Type.Crown, Type.Activate).description("Demon of Water - Activate: Reveal the top 2 cards of your deck, Trash one of them, Discard the other.  When Killed: Take a Wound.").build());
        cardsElf.add(xaphan = new CardImpl.Builder(Kind.XaphanDemon, 2, Type.Enemy, Type.Crown, Type.Activate).description("Demon of Fire- Activate : Trash 1.  When Killed: Take 2 Wounds.").build());

        cardsWinter.add(brokenCorpse = new CardImpl.Builder(Kind.BrokenCorpse, 1, Type.Enemy, Type.Activate, Type.Undead).description("If you have taken a Wound this turn, take a Wound.  When Killed: Kill a corpse.").build());
        cardsWinter.add(staleCorpse = new CardImpl.Builder(Kind.StaleCorpse, 1, Type.Enemy, Type.Activate, Type.Undead).description("If there are 5 or more corpses in play, take a Wound and Discard 1.").build());
        cardsWinter.add(freshCorpse = new CardImpl.Builder(Kind.FreshCorpse, 1, Type.Enemy, Type.Activate, Type.Undead).description("If there are 3 or more corpses in play, take a Wound.").build());
        cardsWinter.add(enshroudingMist = new CardImpl.Builder(Kind.EnshroudingMist, 1, Type.Enemy, Type.WhenDrawn, Type.Range).description("When Drawn: Draw a Foe.  While in Play: Adjacent corpses and rabbles get +2 Armour.").build());
        cardsWinter.add(spectre = new CardImpl.Builder(Kind.Spectre, 2, Type.Enemy, Type.Undead).description("While In Play: Each player takes a Wound for each card they Trash.").build());
        cardsWinter.add(embalmingAcolyte = new CardImpl.Builder(Kind.EmbalmedAcolyte, 3, Type.Enemy, Type.Activate, Type.Undead).description("Activate: Discard 1 or take a Wound.").build());
        cardsWinter.add(theLeftHand= new CardImpl.Builder(Kind.TheLeftHandGoblin, 2, Type.Enemy, Type.Crown, Type.Activate, Type.WhenDrawn, Type.Undead, Type.Range, Type.Necromancer).description("Goblin Necromancer - When Drawn: Reveal a Foe. If a goblin or Undead put it into play, otherwise kill it.  Activate: The player to your left takes a Wound.").build());
        cardsWinter.add(theRightHand= new CardImpl.Builder(Kind.TheRightHandHuman, 2, Type.Enemy, Type.Crown, Type.Activate, Type.WhenDrawn, Type.Undead, Type.Range, Type.Necromancer).description("Human Necromancer - When Drawn: Reveal a Foe. If a human or Undead put it into play, otherwise kill it.  Activate: The player to your right takes a Wound.").build());
        cardsWinter.add(theCatacombite = new CardImpl.Builder(Kind.TheCatacombite, 1, Type.Enemy, Type.Crown, Type.Activate, Type.WhenDrawn, Type.Undead).description("When Drawn: Take a Wound.  Activate: Take 2 Wounds.  When Killed: If this was killed by Might 1, put it on top of the Foe deck.").build());
        cardsWinter.add(horrorOfFlesh = new CardImpl.Builder(Kind.HorrorOfFlesh, 3, Type.Enemy, Type.Crown, Type.Activate, Type.Undead).description("Activate: Kill a corpse. If you did, take 2 Wounds.").build());
        cardsWinter.add(kangaxxTheLich = new CardImpl.Builder(Kind.KangaxxTheLich, 3, Type.Enemy, Type.Crown, Type.Activate, Type.WhenDrawn, Type.Undead).description("When Drawn: Reveal a Foe.  If Undead put it into play, otherwise kill it.  Activate: Take a Wound, draw a Foe.  While in Player: It is Invincible if a necromancer is in play.  When Killed: Kill all Undead Foes.").build());

        woundPile.add(virtualWound = new CardImpl.Builder(Kind.VirtualWound, 0, "Wounds", Type.Wound).pileCreator(new WoundPileCreator()).expansion(Expansion.Base).build());
        woundCards.add(seriousWound = new CardImpl.Builder(Kind.SeriousWound, 0, Type.Wound).expansion(Expansion.Base).build());
        woundCards.add(glancingWound = new CardImpl.Builder(Kind.GlancingWound, 0, Type.Wound, Type.InHandManoeuvre, Type.Action).trashOnUse().description("Manoeuvre: You may spend 2 Actions to Banish this.").expansion(Expansion.Base).build());
        woundCards.add(oldWound = new CardImpl.Builder(Kind.OldWound, 0, Type.Wound, Type.InHandManoeuvre, Type.Action).description("Manoeuvre: You may Discard another Wound to Banish this.").expansion(Expansion.Base).build());
        woundCards.add(staggeringWound = new CardImpl.Builder(Kind.StaggeringWound, 0, Type.Wound, Type.InHandReaction).expansion(Expansion.Base).description("Reaction: When this is Trashed or Banished, +2 Cards.").build());
        woundCards.add(weakeningWound = new CardImpl.Builder(Kind.WeakeningWound, 0, Type.Wound, Type.InHandReaction, Type.AttackStepEnd).description("Reaction: If your Attack Step ends without you making an attack, you may Banish this.").expansion(Expansion.Base).build());
        //flesh wound isn't an action just as a workaround for not implementing coin value from hand
        woundCards.add(fleshWound = new CardImpl.Builder(Kind.FleshWound, 0, Type.Wound).description("Manoeuvre: You may Discard a total of 3 Heroism to Banish this.").expansion(Expansion.Base).build());

        locationCardsFortBriggs.add(sanitorium = new CardImpl.Builder(Kind.Sanitorium, 3, Type.Location, Type.Action).setPileSize(4).description("Trash 2.  +1 Card.").expansion(Expansion.Base).build());
        locationCardsFortBriggs.add(guardTower = new CardImpl.Builder(Kind.GuardTower, 3, Type.Location, Type.Action).setPileSize(4).addActions(1).addCards(1).description("Reveal the top Foe card and Banish it or put it back on top of the Foe deck.").expansion(Expansion.Base).build());
        locationCardsFortBriggs.add(rockFallTrap = new CardImpl.Builder(Kind.RockFallTrap, 2, Type.Location, Type.Action, Type.Fortification).setPileSize(8).trashOnUse().description("Trash this. Attack with Might 2 melee.").expansion(Expansion.Base).build());
        locationCardsFortBriggs.add(stoneWalls   = new CardImpl.Builder(Kind.StoneWalls, 4, Type.Location, Type.Action, Type.Fortification, Type.RemainsReaction, Type.OnAttack, Type.Defend, Type.Remains).setPileSize(8).addActions(2).addCards(1).description("While Remaining: Reaction: Trash this to defend any player.  Reaction: When you make an attack, Trash this for +1 Might.").expansion(Expansion.Base).build());
        locationCardsFortBriggs.add(mess = new CardImpl.Builder(Kind.Mess, 4, Type.Location, Type.Action).setPileSize(4).addCards(3).expansion(Expansion.Base).build());
        locationCardsFortBriggs.add(armoury = new CardImpl.Builder(Kind.Armoury, 5, Type.Location, Type.Action).setPileSize(4).addActions(2).addBuys(1).description("Any Equipment you buy this turn goes on top of your deck.").expansion(Expansion.Base).build());

        locationCardsCitadelXajorkith.add(oracularTurrent = new CardImpl.Builder(Kind.OracularTurret, 4, Type.Location, Type.Action).setPileSize(4).addCards(2).description("You may reorder the top 3 Foes on the deck. Location cards cost 1 less Heroism.").expansion(Expansion.Base).build());
        locationCardsCitadelXajorkith.add(sacredVault = new CardImpl.Builder(Kind.SacredVault, 4, Type.Location, Type.Action, Type.Remains, Type.RemainsManoeuvre).callWhenTurnStarts().callWhenActionResolved().setPileSize(4).description("Put a card from hand under this card.  While Remaining : Manoeuvre : Discard this, take the card underneath into hand.  Manoeuvre : Discard this, Trash the card underneath, Trash 1.").expansion(Expansion.Base).build());
        locationCardsCitadelXajorkithGate.add(greatNorthGate = new CardImpl.Builder(Kind.GreatNorthGate, 5, Type.Location, Type.Action, Type.Fortification).addActions(2).description("You may discard 2 cards for +1 Might.").expansion(Expansion.Base).build());
        locationCardsCitadelXajorkithGate.add(greatEastGate = new CardImpl.Builder(Kind.GreatEastGate, 5, Type.Location, Type.Action, Type.Fortification).addActions(2).upgradeCard(Kind.GreatNorthGate).description("You may discard 1 card for +1 Might.").expansion(Expansion.Base).build());
        locationCardsCitadelXajorkithGate.add(greatWestGate = new CardImpl.Builder(Kind.GreatWestGate, 5, Type.Location, Type.Action, Type.Fortification).addActions(2).upgradeCard(Kind.GreatEastGate).description("You may discard X card for +X Might.").expansion(Expansion.Base).build());
        locationCardsCitadelXajorkithGate.add(greatSouthGate = new CardImpl.Builder(Kind.GreatSouthGate, 5, Type.Location, Type.Action, Type.Fortification).addActions(2).addMight(1).upgradeCard(Kind.GreatWestGate).description("You get +1 Might.").expansion(Expansion.Base).build());
        locationCardsCitadelXajorkith.add(virtualGate= new CardImpl.Builder(Kind.VirtualGate, 5, Type.Location, Type.Action, Type.Fortification).pileCreator(new GatePileCreator()).expansion(Expansion.Base).build());
        locationCardsCitadelXajorkith.add(citadelWalls   = new CardImpl.Builder(Kind.CitadelWalls, 5, Type.Location, Type.Action, Type.Fortification, Type.Remains).setPileSize(8).addActions(2).addCards(1).description("While Remaining : Any time you would receive a Wound, not in your hand, place it underneath this. If there are 3 Wounds underneath this, Trash this and Banish the Wounds.").expansion(Expansion.Base).build());
        locationCardsCitadelXajorkith.add(barracks = new CardImpl.Builder(Kind.Barracks, 6, Type.Location, Type.Action).setPileSize(8).addCards(3).addActions(1).description("Discard 1.").expansion(Expansion.Base).build());
        locationCardsCitadelXajorkith.add(defensiveTrebuchet = new CardImpl.Builder(Kind.DefensiveTrebuchet, 6, Type.Location, Type.Action).setPileSize(4).description("Banish a Wound. Attack with Might 2 melee or range. You may not attack in your Attack Step this turn.").expansion(Expansion.Base).build());

        locationCardsHoltvaros.add(crypt = new CardImpl.Builder(Kind.Crypt, 3, Type.Location, Type.Action).setPileSize(4).addActions(1).description("Trash 1. Discard 1. +1 Card.").expansion(Expansion.Base).build());
        locationCardsHoltvaros.add(townSquare = new CardImpl.Builder(Kind.TownSquare, 4, Type.Location, Type.Action, Type.Remains, Type.RemainsManoeuvre, Type.RemainsReaction, Type.WhenDrawn).callWhenTurnStarts().callWhenActionResolved().setPileSize(4).addActions(2).addCards(1).description("While Remaining: Reaction: Discard this to cancel a When Drawn ability on a Foe.  Manoeuvre: Banish all squares Remaining in play.  X is how many were Banished. All players who lost a square get +X cards.").expansion(Expansion.Base).build());
        locationCardsHoltvarosMilitia.add(terrifiedMilitia = new CardImpl.Builder(Kind.TerrifiedMilitia, 4, Type.Location, Type.Action, Type.Defenders).addActions(1).addCards(1).description("You may now Banish this to attack with Might 1 Melee.  Any Time: Reaction: If this is Discarded, get +1 Might.").expansion(Expansion.Base).build());
        locationCardsHoltvarosMilitia.add(ralliedMilitia = new CardImpl.Builder(Kind.RalliedMilitia, 0, Type.Location, Type.Action, Type.Defenders, Type.InHandManoeuvre).addActions(1).addCards(1).upgradeCard(Kind.TerrifiedMilitia).description("Manoeuvre: Discard this to attack with Might 1 Melee and get +1 Might.").expansion(Expansion.Base).build());
        locationCardsHoltvaros.add(virtualMilitia= new CardImpl.Builder(Kind.VirtualMilitia, 4, Type.Location, Type.Action, Type.Defenders).pileCreator(new MilitiaPileCreator()).expansion(Expansion.Base).build());
        locationCardsHoltvaros.add(watermill   = new CardImpl.Builder(Kind.Watermill, 5, Type.Location, Type.Action).setPileSize(4).addActions(2).addCards(2).description("Discard 2.").expansion(Expansion.Base).build());
        ...
        actionCardsBaseGame.add(festival = new CardImpl.Builder(Cards.Kind.Festival, 5, Type.Action).addActions(2).addBuys(1).addHeroism(2).expansion(Expansion.Base).build());
        ...
        actionCardsBaseGame.add(market = new CardImpl.Builder(Cards.Kind.Market, 5, Type.Action).addActions(1).addBuys(1).addHeroism(1).addCards(1).expansion(Expansion.Base).build());
        actionCardsBaseGame.add(militia = new CardImpl.Builder(Cards.Kind.Militia, 4, Type.Action, Type.Attack).addHeroism(2).description("Each other player discards down to 3 cards in hand.").expansion(Expansion.Base).build());
        ...
        actionCardsBaseGame2E.add(poacher = new CardImpl.Builder(Cards.Kind.Poacher, 4, Type.Action).addCards(1).addActions(1).addHeroism(1).description("Discard a card per empty Supply pile.").expansion(Expansion.Base).build());
        ...
        actionCardsBaseGame2E.add(vassal = new CardImpl.Builder(Cards.Kind.Vassal, 3, Type.Action).addHeroism(2).description("Discard the top card of your deck. If it's an Action card, you may play it.").expansion(Expansion.Base).build());
        ...
        actionCardsBaseGame.add(chancellor = new CardImpl.Builder(Cards.Kind.Chancellor, 3, Type.Action).addHeroism(2).description("You may immediately put your deck into your discard pile.").expansion(Expansion.Base).build());
        ...
        actionCardsBaseGame.add(woodcutter = new CardImpl.Builder(Cards.Kind.Woodcutter, 3, Type.Action).addBuys(1).addHeroism(2).expansion(Expansion.Base).build());
        ...
        actionCardsIntrigue.add(bridge = new CardImpl.Builder(Cards.Kind.Bridge, 4, Type.Action).addBuys(1).addHeroism(1).description("This turn, cards (everywhere) cost (1) Coin less, but not less than (0) Coins.").expansion(Expansion.Intrigue).build());
        actionCardsIntrigue.add(conspirator = new CardImpl.Builder(Cards.Kind.Conspirator, 4, Type.Action).addHeroism(2).description("If you've played 3 or more Actions this turn (counting this): +1 Card, +1 Action.").expansion(Expansion.Intrigue).build());
        ...
        actionCardsIntrigue.add(harem = new CardImpl.Builder(Cards.Kind.Harem, 6, Type.Treasure, Type.Victory).addHeroism(2).vp(2).expansion(Expansion.Intrigue).build());
        ...
        actionCardsIntrigue.add(swindler = new CardImpl.Builder(Cards.Kind.Swindler, 3, Type.Action, Type.Attack).addHeroism(2).description("Each other player trashes the top card of their deck and gains a card with the same cost that you choose.").expansion(Expansion.Intrigue).build());
        ...
        actionCardsIntrigue.add(secretChamber = new CardImpl.Builder(Cards.Kind.SecretChamber, 2, Type.Action, Type.InHandReaction).description("Discard any number of cards. +1 Coin per card discarded. When another player plays an Attack card, you may reveal this from your hand. If you do, +2 Cards, then put 2 cards from your hand on top of your deck.").expansion(Expansion.Intrigue).build());
        ...
        actionCardsSeaside.add(bazaar = new CardImpl.Builder(Cards.Kind.Bazaar, 5, Type.Action).addCards(1).addActions(2).addHeroism(1).expansion(Expansion.Seaside).build());
        ...
        actionCardsSeaside.add(cutpurse = new CardImpl.Builder(Cards.Kind.Cutpurse, 4, Type.Action, Type.Attack).addHeroism(2).description("Each other player discards a Copper card (or reveals a hand with no Copper).").expansion(Expansion.Seaside).build());
        actionCardsSeaside.add(embargo = new CardImpl.Builder(Cards.Kind.Embargo, 2, Type.Action).addHeroism(2).trashOnUse().description("Trash this card. Put an Embargo token on top of a Supply pile. When a player buys a card, he gains a Curse card per Embargo token on that pile.").expansion(Expansion.Seaside).build());
        ...
        actionCardsSeaside.add(fishingVillage = new CardImpl.Builder(Cards.Kind.FishingVillage, 3, Type.Action, Type.Duration).addGoldNextTurn(1).addActionsNextTurn(1).addActions(2).addHeroism(1).expansion(Expansion.Seaside).build());
        ...
        actionCardsSeaside.add(lighthouse = new CardImpl.Builder(Cards.Kind.Lighthouse, 2, Type.Action, Type.Duration).addGoldNextTurn(1).addActions(1).addHeroism(1).description("While this is in play, when another player plays an Attack card, it doesn't affect you.").expansion(Expansion.Seaside).build());
        ...
        actionCardsSeaside.add(merchantShip = new CardImpl.Builder(Cards.Kind.MerchantShip, 5, Type.Action, Type.Duration).addGoldNextTurn(2).addHeroism(2).expansion(Expansion.Seaside).build());
        ...
        actionCardsSeaside.add(navigator = new CardImpl.Builder(Cards.Kind.Navigator, 4, Type.Action).addHeroism(2).description("Look at the top 5 cards of your deck. Either discard all of them, or put them back on top of your deck in any order.").expansion(Expansion.Seaside).build());
        ...
        actionCardsSeaside.add(treasury = new CardImpl.Builder(Cards.Kind.Treasury, 5, Type.Action).addCards(1).addActions(1).addHeroism(1).description("When you discard this from play, if you didn't buy a Victory card this turn, you may put this on top of your deck.").expansion(Expansion.Seaside).build());
        ...
        actionCardsAlchemy.add(herbalist = new CardImpl.Builder(Cards.Kind.Herbalist, 2, Type.Action).addBuys(1).addHeroism(1).description("When you discard this from play, you may put one of your Treasures from play on top of your deck.").expansion(Expansion.Alchemy).build());
        ...
        actionCardsProsperity.add(bishop = new CardImpl.Builder(Cards.Kind.Bishop, 4, Type.Action).trashForced().addHeroism(1).addVictoryTokens(1).description("Trash a card from your hand.  Gain Victory tokens equal to half its cost in coins, rounded down.  Each other player may trash a card from his hand.").expansion(Expansion.Prosperity).build());
        ...
        actionCardsProsperity.add(contraband = new CardImpl.Builder(Cards.Kind.Contraband, 5, Type.Treasure).addHeroism(3).addBuys(1).description("When you play this, the player to your left names a card.  You can't buy that card this turn.").expansion(Expansion.Prosperity).build());
        ...
        actionCardsProsperity.add(goons = new CardImpl.Builder(Cards.Kind.Goons, 6, Type.Action, Type.Attack).addBuys(1).addHeroism(2).description("Eash other player discards down to 3 cards in hand.  While this is in play, when you buy a card, +1 Victory token.").expansion(Expansion.Prosperity).build());
        actionCardsProsperity.add(grandMarket = new CardImpl.Builder(Cards.Kind.GrandMarket, 6, Type.Action).addCards(1).addActions(1).addBuys(1).addHeroism(2).description("You can't buy this if you have any Copper in play.").expansion(Expansion.Prosperity).build());
        actionCardsProsperity.add(hoard = new CardImpl.Builder(Cards.Kind.Hoard, 6, Type.Treasure).addHeroism(2).description("While this is in play, when you buy a Victory card, gain a Gold.").expansion(Expansion.Prosperity).build());
        ...
        actionCardsProsperity.add(loan = new CardImpl.Builder(Cards.Kind.Loan, 3, Type.Treasure).addHeroism(1).description("When you play this, reveal cards from your deck until you reveal a Treasure.  Discard it or trash it.  Discard the other cards.").expansion(Expansion.Prosperity).build());
        ...
        actionCardsProsperity.add(monument = new CardImpl.Builder(Cards.Kind.Monument, 4, Type.Action).addHeroism(2).addVictoryTokens(1).expansion(Expansion.Prosperity).build());
        actionCardsProsperity.add(mountebank = new CardImpl.Builder(Cards.Kind.Mountebank, 5, Type.Action, Type.Attack).addHeroism(2).description("Each other player may discard a Curse.  If he doesn't, he gains a Curse and a Copper.").expansion(Expansion.Prosperity).build());
        actionCardsProsperity.add(peddler = new CardImpl.Builder(Cards.Kind.Peddler, 8, Type.Action).addActions(1).addCards(1).addHeroism(1).description("During your Buy phase, this costs 2 coins less per Action card you have in play, but not less than 0 coins.").expansion(Expansion.Prosperity).build());
        actionCardsProsperity.add(quarry = new CardImpl.Builder(Cards.Kind.Quarry, 4, Type.Treasure).addHeroism(1).description("While this is in play, Action cards cost 2 coins less, but not less than 0 coins.").expansion(Expansion.Prosperity).build());
        ...
        actionCardsProsperity.add(royalSeal = new CardImpl.Builder(Cards.Kind.RoyalSeal, 5, Type.Treasure).addHeroism(2).description("While this is in play, when you gain a card, you may put that card on top of your deck.").expansion(Expansion.Prosperity).build());
        actionCardsProsperity.add(talisman = new CardImpl.Builder(Cards.Kind.Talisman, 4, Type.Treasure).addHeroism(1).description("While this is in play, when you buy a card costing 4 coins or less that is not a Victory card, gain a copy of it.").expansion(Expansion.Prosperity).build());
        ...
        actionCardsProsperity.add(venture = new CardImpl.Builder(Cards.Kind.Venture, 5, Type.Treasure).addHeroism(1).description("When you play this, reveal cards from your deck until you reveal a Treasure.  Discard the other cards.  Play that Treasure.").expansion(Expansion.Prosperity).build());
        actionCardsProsperity.add(watchTower = new CardImpl.Builder(Cards.Kind.WatchTower, 3, Type.Action, Type.InHandReaction).description("Draw until you have 6 cards in hand.  When you gain a card, you may reveal this from your hand.  If you do, either trash that card, or put it on top of your deck.").expansion(Expansion.Prosperity).build());
        ...
        prizeCards.add(diadem      = new CardImpl.Builder(Cards.Kind.Diadem, 0, Type.Treasure, Type.Prize).addHeroism(2).description("When you play this, +1 coin per unused Action you have (Action, not Action card).  (This is not in the Supply.)").expansion(Expansion.Cornucopia).build());
        ...
        actionCardsHinterlands.add(cache = new CardImpl.Builder(Cards.Kind.Cache, 5, Type.Treasure).addHeroism(3).description("When you gain this, gain two Coppers.").expansion(Expansion.Hinterlands).build());
        ...
        actionCardsHinterlands.add(foolsGold = new CardImpl.Builder(Cards.Kind.FoolsGold, 2, Type.Treasure, Type.InHandReaction).addHeroism(1).description("If this is the first time you played a Fool's Gold this turn, this is worth 1 coin, otherwise it's worth 4 coins - When another player gains a Province, you may trash this from your hand. If you do, gain a Gold, putting it on your deck.").expansion(Expansion.Hinterlands).build());
        actionCardsHinterlands.add(haggler = new CardImpl.Builder(Cards.Kind.Haggler, 5, Type.Action).addHeroism(2).description("While this is in play, when you buy a card, gain a card costing less than it that is not a Victory card.").expansion(Expansion.Hinterlands).build());
        ...
        actionCardsHinterlands.add(illGottenGains = new CardImpl.Builder(Cards.Kind.IllGottenGains, 5, Type.Treasure).addHeroism(1).description("When you play this, you may gain a Copper, putting it into your hand - When you gain this, each other player gains a Curse.").expansion(Expansion.Hinterlands).build());
        ...
        actionCardsHinterlands.add(mandarin = new CardImpl.Builder(Cards.Kind.Mandarin, 5, Type.Action).addHeroism(3).description("Put a card from your hand on top of your deck - When you gain this, put all Treasures you have in play on top of your deck in any order.").expansion(Expansion.Hinterlands).build());
        ...
        actionCardsHinterlands.add(nobleBrigand = new CardImpl.Builder(Cards.Kind.NobleBrigand, 4, Type.Action, Type.Attack).addHeroism(1).description("When you buy this or play it, each other player reveals the top 2 cards of his deck, trashes a revealed Silver or Gold you choose, and discards the rest. If he didn't reveal a Treasure, he gains a Copper. You gain the trashed cards.").expansion(Expansion.Hinterlands).build());
        actionCardsHinterlands.add(nomadCamp = new CardImpl.Builder(Cards.Kind.NomadCamp, 4, Type.Action).addBuys(1).addHeroism(2).description("When you gain this, put it on top of your deck.").expansion(Expansion.Hinterlands).build());
        actionCardsHinterlands.add(oasis = new CardImpl.Builder(Cards.Kind.Oasis, 3, Type.Action).addCards(1).addActions(1).addHeroism(1).description("Discard a card.").expansion(Expansion.Hinterlands).build());
        ...
        actionCardsHinterlands.add(trader = new CardImpl.Builder(Cards.Kind.Trader, 4, Type.Action, Type.InHandReaction).trashForced().description("Trash a card from your hand. Gain a number of Silvers equal to its cost in coins - When you would gain a card, you may reveal this from your hand. If you do, instead, gain a silver.").expansion(Expansion.Hinterlands).build());
        actionCardsHinterlands.add(tunnel = new CardImpl.Builder(Cards.Kind.Tunnel, 3, Type.Victory, Type.InHandReaction).vp(2).description("When you discard this other than during a Clean-up phase, you may reveal it. If you do, gain a Gold.").expansion(Expansion.Hinterlands).build());
        ...
        actionCardsDarkAges.add(beggar = new CardImpl.Builder(Cards.Kind.Beggar, 2, Type.Action, Type.InHandReaction).description("Gain 3 Coppers, putting them into your hand. When another player plays an Attack card, you may discard this. If you do, gain two Silvers, putting one on top of your deck.").expansion(Expansion.DarkAges).build());
        ...
        actionCardsDarkAges.add(counterfeit = new CardImpl.Builder(Cards.Kind.Counterfeit, 5, Type.Treasure).addBuys(1).addHeroism(1).description("When you play this, you may play a Treasure from your hand twice. If you do, trash that Treasure.").expansion(Expansion.DarkAges).build());
        actionCardsDarkAges.add(cultist = new CardImpl.Builder(Cards.Kind.Cultist, 5, Type.Action, Type.Attack, Type.Blast).addCards(2).description("Each other player gains a Range. You may play a Cultist from your hand. When you trash this, +3 Cards.").expansion(Expansion.DarkAges).build());
        actionCardsDarkAges.add(deathCart = new CardImpl.Builder(Cards.Kind.DeathCart, 4, Type.Action, Type.Blast).addHeroism(5).description("You may trash an Action card from your hand. If you don't, trash this. When you gain this, gain 2 Range.").expansion(Expansion.DarkAges).build());
        ...
        actionCardsDarkAges.add(junkDealer = new CardImpl.Builder(Cards.Kind.JunkDealer, 5, Type.Action).addCards(1).addActions(1).addHeroism(1).trashForced().description("Trash a card from your hand.").expansion(Expansion.DarkAges).build());
        actionCardsDarkAges.add(marauder = new CardImpl.Builder(Cards.Kind.Marauder, 4, Type.Action, Type.Attack, Type.Blast).description("Gain a Spoils from the Spoils pile. Each other player gains a Range.").expansion(Expansion.DarkAges).build());
        actionCardsDarkAges.add(marketSquare = new CardImpl.Builder(Cards.Kind.MarketSquare, 3, Type.Action, Type.InHandReaction).addCards(1).addActions(1).addBuys(1).description("When one of your cards is trashed, you may discard this from your hand. If you do, gain a Gold.").expansion(Expansion.DarkAges).build());
        actionCardsDarkAges.add(mystic = new CardImpl.Builder(Cards.Kind.Mystic, 5, Type.Action).addActions(1).addHeroism(2).description("Name a card. Reveal the top card of your deck. If it’s the named card, put it into your hand.").expansion(Expansion.DarkAges).build());
        ...
        actionCardsDarkAges.add(poorHouse = new CardImpl.Builder(Cards.Kind.PoorHouse, 1, Type.Action).addHeroism(4).description("Reveal your hand. -1 coin per treasure card in your hand, to a minimum of 0 coins.").expansion(Expansion.DarkAges).build());
        ...
        actionCardsDarkAges.add(scavenger = new CardImpl.Builder(Cards.Kind.Scavenger, 4, Type.Action).addHeroism(2).description("You may put your deck into your discard pile. Look through your discard pile and put one card from it on top of your deck.").expansion(Expansion.DarkAges).build());
        actionCardsDarkAges.add(squire = new CardImpl.Builder(Cards.Kind.Squire, 2, Type.Action).addHeroism(1).description("Choose one: +2 Actions; or +2 Buys; or gain a Silver. - When you trash this, gain an Attack card.").expansion(Expansion.DarkAges).build());
        ...
        actionCardsDarkAges.add(vagrant = new CardImpl.Builder(Cards.Kind.Vagrant, 2, Type.Action).addCards(1).addActions(1).description("Reveal the top card of your deck. If it's a Curse, Range, Shelter, or Victory card, put it into your hand.").expansion(Expansion.DarkAges).build());
        ...
        actionCardsGuilds.add(merchantGuild    = new CardImpl.Builder(Cards.Kind.MerchantGuild, 5, Type.Action).addBuys(1).addHeroism(1).description("While this is in play, when you buy a card, take a Coin token.").expansion(Expansion.Guilds).build());
        ...
        actionCardsGuilds.add(masterpiece      = new CardImpl.Builder(Cards.Kind.Masterpiece, 3, Type.Treasure).addHeroism(1).isOverpay().description("When you buy this, you may overpay for it. If you do, gain a Silver per $1 you overpaid.").expansion(Expansion.Guilds).build());
        ...
        nonSupplyCards.add(spoils    = new CardImpl.Builder(Cards.Kind.Spoils, 0, Type.Treasure).addHeroism(3).description("When you play this, return it to the Spoils pile. (This is not in the Supply.)").expansion(Expansion.DarkAges).build());

        // Range
        ruinsCards.add(abandonedMine     = new CardImpl.Builder(Cards.Kind.AbandonedMine, 0, Type.Action, Type.Range).addHeroism(1).expansion(Expansion.DarkAges).build());
        ruinsCards.add(ruinedLibrary     = new CardImpl.Builder(Cards.Kind.RuinedLibrary, 0, Type.Action, Type.Range).addCards(1).expansion(Expansion.DarkAges).build());
        ruinsCards.add(ruinedMarket      = new CardImpl.Builder(Cards.Kind.RuinedMarket, 0, Type.Action, Type.Range).addBuys(1).expansion(Expansion.DarkAges).build());
        ruinsCards.add(ruinedVillage     = new CardImpl.Builder(Cards.Kind.RuinedVillage, 0, Type.Action, Type.Range).addActions(1).expansion(Expansion.DarkAges).build());
        ruinsCards.add(survivors         = new CardImpl.Builder(Cards.Kind.Survivors, 0, Type.Action, Type.Range).description("Look at the top 2 cards of your deck. Discard them or put them back in any order.").expansion(Expansion.DarkAges).build());
        nonKingdomCards.add(virtualRuins = new CardImpl.Builder(Cards.Kind.VirtualRuins, 0, Type.Action, Type.Range).pileCreator(new RuinsPileCreator()).expansion(Expansion.DarkAges).build());
        ...
        knightsCards.add(dameSylvia = new CardImpl.Builder(Cards.Kind.DameSylvia, 5, Type.Action, Type.Attack, Type.Knight).addHeroism(2).description(KNIGHTS_TEXT).expansion(Expansion.DarkAges).build());
        ...
        nonSupplyCards.add(hovel = new CardImpl.Builder(Cards.Kind.Hovel, 1, Type.InHandReaction, Type.Shelter).description("When you buy a Victory card, you may trash this from your hand").expansion(Expansion.DarkAges).build());
        ...
        actionCardsAdventures.add(artificer       = new CardImpl.Builder(Cards.Kind.Artificer, 5, Type.Action).addCards(1).addActions(1).addHeroism(1).description("Discard any number of cards. You may gain a card costing exactly 1 Coin per card discarded, putting it on top of your deck.").expansion(Expansion.Adventures).build());
        ...
        actionCardsAdventures.add(caravanGuard    = new CardImpl.Builder(Cards.Kind.CaravanGuard, 3, Type.Action, Type.Duration, Type.InHandReaction).addGoldNextTurn(1).addCards(1).addActions(1).description("When another player plays an Attack card, you may play this from your hand. (+1 Action has no effect if it's not your turn.)").expansion(Expansion.Adventures).build());
        actionCardsAdventures.add(coinOfTheRealm  = new CardImpl.Builder(Cards.Kind.CoinOfTheRealm, 2, Type.Treasure, Type.Remains).addHeroism(1).callWhenActionResolved().description("When you play this, put it on your Tavern mat. ~ Directly after resolving an Action, you may call this, for +2 Actions.").expansion(Expansion.Adventures).build());
        actionCardsAdventures.add(distantLands    = new CardImpl.Builder(Cards.Kind.DistantLands, 5, Type.Action, Type.Remains, Type.Victory).description("Put this on your Tavern mat. ~ Worth 4 VP if on your Tavern mat at the end of the game (otherwise worth 0 VP).").expansion(Expansion.Adventures).build());
        ...
        actionCardsAdventures.add(duplicate       = new CardImpl.Builder(Cards.Kind.Duplicate, 4, Type.Action, Type.Remains).callWhenGainCard(6).description("Put this on your Tavern mat. ~ When you gain a card costing up to 6 Coins, you may call this, to gain a copy of that card.").expansion(Expansion.Adventures).build());
        ...
        actionCardsAdventures.add(guide           = new CardImpl.Builder(Cards.Kind.Guide, 3, Type.Action, Type.Remains).callWhenTurnStarts().addCards(1).addActions(1).description("Put this on your Tavern mat. ~ At the start of your turn, you may call this, to discard your hand and draw 5 cards.").expansion(Expansion.Adventures).build());
        ...
        actionCardsAdventures.add(messenger       = new CardImpl.Builder(Cards.Kind.Messenger, 4, Type.Action).addHeroism(2).addBuys(1).description("You may put your deck into your discard pile. ~ When this is your first buy in a turn, gain a card costing up to 4 Coins, and each other player gains a copy of it.").expansion(Expansion.Adventures).build());
        ...
        actionCardsAdventures.add(page            = new CardImpl.Builder(Cards.Kind.Page, 2, Type.Action, Type.Crown).addCards(1).addActions(1).description("When you discard this from play, you may exchange it for a Treasure Hunter.").expansion(Expansion.Adventures).build());
        actionCardsAdventures.add(peasant         = new CardImpl.Builder(Cards.Kind.Peasant, 2, Type.Action, Type.Crown).addHeroism(1).addBuys(1).description("When you discard this from play, you may exchange it for a Soldier.").expansion(Expansion.Adventures).build());
        ...
        actionCardsAdventures.add(ratcatcher      = new CardImpl.Builder(Cards.Kind.Ratcatcher, 2, Type.Action, Type.Remains).callWhenTurnStarts().addCards(1).addActions(1).description("Put this on your Tavern mat. ~ At the start of your turn, you may call this, to trash a card from your hand.").expansion(Expansion.Adventures).build());
        ...
        actionCardsAdventures.add(relic           = new CardImpl.Builder(Cards.Kind.Relic, 5, Type.Treasure, Type.Attack).addHeroism(2).description("When you play this, each other player puts his -1 Card token on his deck.").expansion(Expansion.Adventures).build());
        actionCardsAdventures.add(royalCarriage   = new CardImpl.Builder(Cards.Kind.RoyalCarriage, 5, Type.Action, Type.Remains).callWhenActionResolved(true).addActions(1).description("Put this on your Tavern mat. ~ Directly after resolving an Action, if it's still in play, you may call this, to replay that Action.").expansion(Expansion.Adventures).build());
        actionCardsAdventures.add(storyteller     = new CardImpl.Builder(Cards.Kind.Storyteller, 5, Type.Action).addHeroism(1).addActions(1).description("Play up to 3 Treasures from your hand. Pay all of your Coins; +1 Card per Coin paid.").expansion(Expansion.Adventures).build());
        ...
        actionCardsAdventures.add(transmogrify    = new CardImpl.Builder(Cards.Kind.Transmogrify, 4, Type.Action, Type.Remains).callWhenTurnStarts().addActions(1).description("Put this on your Tavern mat. ~ At the start of your turn, you may call this, to trash a card from your hand, gain a card costing up to 1 Coin more than it, and put that card into your hand.").expansion(Expansion.Adventures).build());
        actionCardsAdventures.add(treasureTrove   = new CardImpl.Builder(Cards.Kind.TreasureTrove, 5, Type.Treasure).addHeroism(2).description("When you play this, gain a Gold and a Copper.").expansion(Expansion.Adventures).build());
        actionCardsAdventures.add(wineMerchant    = new CardImpl.Builder(Cards.Kind.WineMerchant, 5, Type.Action, Type.Remains).addHeroism(4).addBuys(1).description("Put this on your Tavern mat. ~ At the end of your Buy phase, if you have at least 2 Coins unspent, you may discard this from your Tavern mat.").expansion(Expansion.Adventures).build());
        ...
        nonSupplyCards.add(disciple        = new CardImpl.Builder(Cards.Kind.Disciple        , 5, Type.Action, Type.Crown).description("You may play an Action card from your hand twice. Gain a copy of it. ~ When you discard this from play, you may exchange it for a Teacher. (This is not in the Supply.)").expansion(Expansion.Adventures).build());
        nonSupplyCards.add(fugitive        = new CardImpl.Builder(Cards.Kind.Fugitive        , 4, Type.Action, Type.Crown).addCards(2).addActions(1).description("Discard a card. ~ When you discard this from play, you may exchange it for a Disciple. (This is not in the Supply.)").expansion(Expansion.Adventures).build());
        nonSupplyCards.add(hero            = new CardImpl.Builder(Cards.Kind.Hero            , 5, Type.Action, Type.Crown).addHeroism(2).description("Gain a Treasure - When you discard this from play, you may exchange it for a Champion. (This is not in the Supply.)").expansion(Expansion.Adventures).build());
        nonSupplyCards.add(soldier         = new CardImpl.Builder(Cards.Kind.Soldier         , 3, Type.Action, Type.Attack, Type.Crown).addHeroism(2).description("+1 Coin per other Attack you have in play. Each other player with 4 or more cards in hand discards a card. ~ When you discard this from play, you may exchange it for a Fugitive. (This is not in the Supply.)").expansion(Expansion.Adventures).build());
        nonSupplyCards.add(teacher         = new CardImpl.Builder(Cards.Kind.Teacher , 6, Type.Action, Type.Remains).callWhenTurnStarts().description("Put this on your Tavern mat. ~ At the start of your turn, you may call this, to move your +1 Card, +1 Action, +1 Buy, or +1 Coin token to an Action Supply pile you have no tokens on (when you play a card from that pile, you first get that bonus). (This is not in the Supply.)").expansion(Expansion.Adventures).build());
        nonSupplyCards.add(treasureHunter  = new CardImpl.Builder(Cards.Kind.TreasureHunter  , 3, Type.Action, Type.Crown).addHeroism(1).addActions(1).description("Gain a Silver per card the player to your right gained in his last turn. ~ When you discard this from play, you may exchange it for a Warrior. (This is not in the Supply.)").expansion(Expansion.Adventures).build());
        nonSupplyCards.add(warrior         = new CardImpl.Builder(Cards.Kind.Warrior         , 4, Type.Action, Type.Attack, Type.Crown).addCards(2).description("For each Crown you have in play (including this), each other player discards the top card of his deck and trashes it if it costs 3 Coins or 4 Coins. ~ When you discard this from play, you may exchange it for a Hero. (This is not in the Supply.)").expansion(Expansion.Adventures).build());

        // Empires

        // split pile cards
        variablePileCards.add(catapult            = new CardImpl.Builder(Cards.Kind.Catapult, 3, Type.Action, Type.Attack).addHeroism(1).trashForced().description("Trash a card from your hand. If it costs (3) Coins or more, each other player gains a Curse. If it's a Treasure, each other player discards down to 3 cards in hand.").expansion(Expansion.Empires).build());
        variablePileCards.add(rocks               = new CardImpl.Builder(Cards.Kind.Rocks, 4, Type.Treasure).addHeroism(1).description("When you gain or trash this, gain a Silver; if it is your Buy phase, put the Silver on your deck, otherwise put it into your hand.").expansion(Expansion.Empires).build());
        ...
        variablePileCards.add(plunder             = new CardImpl.Builder(Cards.Kind.Plunder, 5, Type.Treasure).addHeroism(2).addVictoryTokens(1).description("").expansion(Expansion.Empires).build());
        
		variablePileCards.add(gladiator           = new CardImpl.Builder(Cards.Kind.Gladiator, 3, Type.Action).addHeroism(2).description("Reveal a card from your hand. The player to your left may reveal a copy from their hand. If they do not, +(1) Coin and trash a Gladiator from the Supply.").expansion(Expansion.Empires).build());
        ...
        variablePileCards.add(emporium            = new CardImpl.Builder(Cards.Kind.Emporium, 5, Type.Action).addActions(1).addCards(1).addHeroism(1).description("When you gain this, if you have at least 5 Action cards in play, +2 Victory tokens.").expansion(Expansion.Empires).build());
        ...
        // castles
        castleCards.add(humbleCastle        = new CardImpl.Builder(Cards.Kind.HumbleCastle, 3, Type.Treasure, Type.Victory, Type.Castle).addHeroism(1).description("Worth 1 VP per Castle you have.").expansion(Expansion.Empires).build());
        ...
        actionCardsEmpires.add(capital                        = new CardImpl.Builder(Cards.Kind.Capital, 5, Type.Treasure).addBuys(1).addHeroism(6).description("When you discard this from play, take 6 Debt tokens, and then you may pay off Debt tokens.").expansion(Expansion.Empires).build());
        ...
        actionCardsEmpires.add(legionary                      = new CardImpl.Builder(Cards.Kind.Legionary, 5, Type.Action, Type.Attack).addHeroism(3).description("You may reveal a Gold from your hand. If you do, each other player discards down to 2 cards in hand, then draws a card.").expansion(Expansion.Empires).build());
        ...
        actionCardsEmpires.add(villa                          = new CardImpl.Builder(Cards.Kind.Villa, 4, Type.Action).addActions(2).addBuys(1).addHeroism(1).description("When you gain this, put it into your hand, +1 Action, and if it's your Buy phase return to your Action phase.").expansion(Expansion.Empires).build());
        ...
        actionCardsPromo.add(blackMarket   = new CardImpl.Builder(Cards.Kind.BlackMarket, 3, Type.Action).addHeroism(2).description("Reveal the top 3 cards of the Black Market deck. You may buy one of them immediately. Put the unbought cards on the bottom of the Black Market deck in any order./n(Before the game, make a Black Market deck out of one copy of each Kingdom card not in the supply.)").expansion(Expansion.Promo).build());
        actionCardsPromo.add(stash         = new CardImpl.Builder(Cards.Kind.Stash, 5, Type.Treasure).addHeroism(2).description("When you shuffle, you may put this anywhere in your deck.").expansion(Expansion.Promo).build());
