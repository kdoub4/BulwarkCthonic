...
//-add to Kind
    ...
    static {
        ...
        heroCardsJakab.add(virtualSpell = new CardImpl.Builder(Kind.VirtualDaggers, 3, CardType.Hero, CardType.Action, CardType.Equipment).pileCreator(new JakabSpellPileCreator()).expansion(Expansion.Arcane).build());
        ...
        locationCardsSecretLore.add(starChamber = new CardImpl.Builder(Kind.StarChamber, 2, CardType.Location, CardType.Action, CardType.Remains, CardType.RemainsManoeuvre).callWhenActionResolved().setPileSize(8).description("Remains, put a card from Hand underneath this.").expansion(Expansion.Arcane).build());
