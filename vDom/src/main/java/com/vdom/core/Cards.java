...
//-add to Kind
    ...
    public enum Kind {
        ...
        TuskedDeathcharger, HeraldOfGraniteEarthElemental, HeraldOfStarsAirElemental, HeraldOfScorchingFireElemental, HeraldOfPressureWaterElemental,
        ArcaneMessiah,
    ...
    static {
        ...
        cardsMessianic.add(heraldPressure = new CardImpl.Builder(Kind.HeraldOfPressureWaterElemental, 2, CardType.Enemy, CardType.Crown, CardType.Magical, CardType.Range, CardType.WhenDrawn).description("When Drawn: Reveal the top card of the Foe deck. If it is an Elemental, take 2 Wounds. Either way, replace the card.  While In Play: Players cannot defend against Wounds and player invincibilty is cancelled. When Killed: Draw a Foe.").build());
