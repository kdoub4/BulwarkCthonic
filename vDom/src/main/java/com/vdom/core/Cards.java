...
//-add to Kind
    ...
    public static ArrayList<Card> heroCardsJakab = new ArrayList<Card>();
    public static ArrayList<Card> tomeCardsJakab = new ArrayList<Card>();
    public static ArrayList<Card> staffCardsJakab = new ArrayList<Card>();
    public static ArrayList<Card> spellCardsJakab = new ArrayList<>();
    ...
    public enum Kind {
        ...
        //Jakab Startouched
        MagicMissile, CrystalOrb, CelestialTome, CelestialGrimoire, Fireball, EnchantedStrike,
        Petrify, Celerity, Augury, WallOfForce, CedarStaff, AshStaff, RunicStaff, AstrologersRitual,
        VirtualTome, VirtualSpell, VirtualStaffJakab,
    ...
    public static final Card enchantedStrike;
    ...
    static {
        ...
        heroismCards.add(two = new CardImpl.Builder(Cards.Kind.Two, 3, CardType.Hero, CardType.Treasure).addHeroism(2).build());
        heroismCards.add(three = new CardImpl.Builder(Cards.Kind.Three, 3, CardType.Hero, CardType.Treasure).addHeroism(3).addBuys(1).upgradeCard(Kind.Two).build());
        ...
        //Jakab
        heroCardsJakab.add(magicMissile = new CardImpl.Builder(Kind.MagicMissile, 0, CardType.Hero, CardType.Action, CardType.Spell, CardType.Range).setAttacks(1).setPileSize(2).addCards(1).expansion(Expansion.Arcane).build());
        heroCardsJakab.add(crystalOrb = new CardImpl.Builder(Kind.CrystalOrb, 0, CardType.Hero, CardType.Action).addActions(1).setPileSize(1).description("Reveal the top card of your deck - Discard it or return it, +1 Card.").expansion(Expansion.Arcane).build()); //TODO Bulwark multiplayer
        tomeCardsJakab.add(celestialTome = new CardImpl.Builder(Kind.CelestialTome, 2, CardType.Hero, CardType.Action, CardType.Remains, CardType.RemainsManoeuvre, CardType.Equipment).addActions(1).addCards(1).callWhenActionResolved().description("While Remaining: Manoeuvre - Banish this for +1 Action.").expansion(Expansion.Arcane).build()); //TODO Bulwark multiplayer
        tomeCardsJakab.add(celestialGrimoire = new CardImpl.Builder(Kind.CelestialGrimoire, 2, CardType.Hero, CardType.Action, CardType.Remains, CardType.RemainsManoeuvre, CardType.Equipment).addActions(2).addCards(1).callWhenActionResolved().upgradeCard(Kind.CelestialTome).description("You may put a spell from your hand underneath this.  While Remaining: Manoeuvre - Discard this for +1 Action and take any cards underneath into your hand.").expansion(Expansion.Arcane).build());
        spellCardsJakab.add(fireball = new CardImpl.Builder(Kind.Fireball, 3, CardType.Hero, CardType.Action, CardType.Spell).description("Banish this. Make a Might 1 Range or Melee attack  Spellcasting: When you cast this spell, spend up to 2 extra Actions, each Action spent increases the Might of the attack by 1.").expansion(Expansion.Arcane).build());
        spellCardsJakab.add(enchantedStrike = new CardImpl.Builder(Kind.EnchantedStrike, 3, CardType.Hero, CardType.Action, CardType.Spell, CardType.Remains, CardType.RemainsReaction, CardType.OnAttack).description("Remains in front of any player.  While Remaining: Reaction - When this player attacks, they may Banish this for +1 Might.").expansion(Expansion.Arcane).build());
        spellCardsJakab.add(petrify = new CardImpl.Builder(Kind.Petrify, 3, CardType.Hero, CardType.Action, CardType.Spell, CardType.Remains).description("Remains on top of a Foe in play.  Spellcasting: You may spend up to 2 extra Actions to put Wound cards under this from the deck, 1 per Action spent.  While Remaining: This Foe is not in play. Banish this or a Wound underneath this whenever it would activate.").expansion(Expansion.Arcane).build());
        spellCardsJakab.add(celerity= new CardImpl.Builder(Kind.Celerity, 3, CardType.Hero, CardType.Action, CardType.Spell, CardType.Duration).takeAnotherTurn(5).description("Banish this. You may not buy any cards this turn. Do not activate any Foes this turn. Take another turn after this one. Do not draw a Foe at the start of that turn.").expansion(Expansion.Arcane).build());
        spellCardsJakab.add(augury = new CardImpl.Builder(Kind.Augury, 3, CardType.Hero, CardType.Action, CardType.Spell, CardType.InHandManoeuvre).description("Banish this. Reveal the top 2 Foes, Banish one and return the other.  When in Hand: Manoeuvre - Spend up to 3 actions and Banish this. Pick a player. That player reveals cards from their deck equal to the Actions spent. They put at most 1 those cards on their deck and Discard the others.").expansion(Expansion.Arcane).build());
        spellCardsJakab.add(wallOfForce= new CardImpl.Builder(Kind.WallOfForce, 3, CardType.Hero, CardType.Action, CardType.Spell, CardType.Remains).callWhenTurnStarts().description("While Remaining: Each player can take at most one Wound each turn. Banish this at the start of your turn.  Spellcasting: When you cast this spell, you may spend 2 extra Actions to become Invincible until this is Banished.").expansion(Expansion.Arcane).build());
        heroCardsJakab.add(virtualTome = new CardImpl.Builder(Kind.VirtualTome, 2, CardType.Hero, CardType.Action, CardType.Equipment).pileCreator(new JakabTomePileCreator()).expansion(Expansion.Arcane).build());
        heroCardsJakab.add(virtualSpell = new CardImpl.Builder(Kind.VirtualSpell, 3, CardType.Hero, CardType.Action, CardType.Equipment).pileCreator(new JakabSpellPileCreator()).expansion(Expansion.Arcane).build());
        heroCardsJakab.add(virtualStaffJakab = new CardImpl.Builder(Kind.VirtualStaffJakab, 4, CardType.Hero, CardType.Action, CardType.Attack, CardType.Equipment).pileCreator(new JakabStaffPileCreator()).expansion(Expansion.Arcane).build());
        staffCardsJakab.add(cedarStaff = new CardImpl.Builder(Kind.CedarStaff, 4, CardType.Hero, CardType.Action, CardType.Attack, CardType.Equipment).setAttacks(1).addActions(1).addCards(1).description("+1 Buy only if you buy a Spell.").expansion(Expansion.Arcane).build());
        staffCardsJakab.add(ashStaff = new CardImpl.Builder(Kind.AshStaff, 2, CardType.Hero, CardType.Action, CardType.Attack, CardType.Equipment).upgradeCard(Kind.CedarStaff).setAttacks(1).addActions(2).addCards(1).description("+1 Buy only if you buy a Spell.").expansion(Expansion.Arcane).build());
        staffCardsJakab.add(runicStaff = new CardImpl.Builder(Kind.RunicStaff, 2, CardType.Hero, CardType.Action, CardType.Attack, CardType.Equipment, CardType.Range).upgradeCard(Kind.AshStaff).setAttacks(1).addActions(2).addCards(1).description("+1 Buy only if you buy a Spell. Spells cost one less Heroism than their printed cost.").expansion(Expansion.Arcane).build());
        heroCardsJakab.add(astrologersRitual = new CardImpl.Builder(Kind.AstrologersRitual, 5, CardType.Hero, CardType.Action, CardType.Technique, CardType.RemainsReaction, CardType.Remains, CardType.OnAttack).setPileSize(3).addActions(2).description("While Remaining: Reaction - Discard 2 rituals from play for +1 Might. Reaction - Discard 3 rituals from play for +2 Might.").expansion(Expansion.Arcane).build());
        ...
        cardsMessianic.add(brainwashedRabble= new CardImpl.Builder(Kind.RabbleBrainwashed, 1, CardType.Enemy, CardType.WhenDrawn).description("When Drawn: Banish all other rabbles in play, draw 2 Foes for each rabble Banished. Ignore the 'When Drawn' ability of any rabble drawn.").build());
        ...
        cardsMessianic.add(heraldScorching= new CardImpl.Builder(Kind.ScorchingHeraldFireElemental, 2, CardType.Enemy, CardType.Crown, CardType.Magical, CardType.WhenDrawn).description("When Drawn: Reveal the top card of the Foe deck. If it is an Elemental, take 2 Wounds. Either way, replace the card.  While In Play: All Wounds players receive go into their hands.  When Killed: Draw a Foe.").build());
        cardsMessianic.add(heraldPressure = new CardImpl.Builder(Kind.PressureHeraldWaterElemental, 2, CardType.Enemy, CardType.Crown, CardType.Magical, CardType.Range, CardType.WhenDrawn).description("When Drawn: Reveal the top card of the Foe deck. If it is an Elemental, take 2 Wounds. Either way, replace the card.  While In Play: Players cannot defend against Wounds and player invincibilty is cancelled. When Killed: Draw a Foe.").build());
        ...
        locationCardsSylvanChorus.add(celestialChorus = new CardImpl.Builder(Kind.CelestialChorus,5, CardType.Location, CardType.Action, CardType.Technique).upgradeCard(Kind.ElvenChorus).addActions(1).description("+2 Might if you have already played a chorus this turn.").expansion(Expansion.Base).build());
        ...
        locationCardsSecretLore.add(starChamber = new CardImpl.Builder(Kind.StarChamber, 2, CardType.Location, CardType.Action, CardType.Remains, CardType.RemainsManoeuvre).callWhenActionResolved().setPileSize(8).description("Remains, put a card from Hand underneath this.  While Remaining: If you receive a wound from a foe, discard this and all cards underneath it.  Manouvre: Put a cars underneath this, at most once per turn. Maouvre: Trash this and all cardsa underenath it. ").expansion(Expansion.Arcane).build());
        locationCardsSecretLore.add(spiralLibrary = new CardImpl.Builder(Kind.SpiralLibrary, 3, CardType.Location, CardType.Action, CardType.InHandReaction, CardType.TurnStart).addActions(2).addBuys(1).setPileSize(4).description("Hunt for a Spell.  Reaction: At the start of your turn, Discard your entire hand for +5 Cards.").expansion(Expansion.Arcane).build());
        locationCardsSecretLoreSpellwrought.add(spellwroughtArrow = new CardImpl.Builder(Kind.SpellwroughtArrow, 5, CardType.Location, CardType.Action, CardType.InHandReaction, CardType.OnAttack, CardType.Spell).description("Discard 1. Attack with Might 1 Melee or Range.  Reaction: When you make an attack, Banish this for +1 Might.").expansion(Expansion.Arcane).build());
        locationCardsSecretLoreSpellwrought.add(spellwroughtHammer = new CardImpl.Builder(Kind.SpellwroughtHammer, 2, CardType.Location, CardType.Action, CardType.InHandReaction, CardType.OnAttack, CardType.Spell).upgradeCard(Kind.SpellwroughtArrow).description("Discard 1. Attack with Might 2 Melee.  Reaction: When you make an attack, Discard this for +1 Might.").expansion(Expansion.Arcane).build());
        ...
        for (Card card : spellCardsJakab) { variablePileCardToRandomizer.put(card, virtualSpell); }
        ...
        for (Card card : heroCardsJakab)  { actionCards.add(card); }
        for (Card card : staffCardsJakab)  { actionCards.add(card); }
        for (Card card : spellCardsJakab)  { actionCards.add(card); }
        for (Card card : tomeCardsJakab)  { actionCards.add(card); }
