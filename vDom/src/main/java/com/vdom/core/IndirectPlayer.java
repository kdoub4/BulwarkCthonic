...
public abstract class IndirectPlayer extends QuickPlayPlayer {
    ...
    public SpiceMerchantOption spiceMerchant_chooseOption(MoveContext context) {
        ...
        return options[selectOption(context, Cards.spiceMerchant, options, null)];
    }
    ...
    public boolean duchess_shouldDiscardCard(MoveContext context, Card card) {
        if(context.isQuickPlay() && shouldAutoPlay_duchess_shouldDiscardCardFromTopOfDeck(context, card)) {
            return super.duchess_shouldDiscardCard(context, card);
        }
        Object[] extras = new Object[3];
	...
	public FoolsGoldOption foolsGold_chooseOption(MoveContext context)
	{
        ...
        return foolsGold_options[selectOption(context, Cards.foolsGold, options, null)];
	}
    ...
    public Card[] cartographer_cardsFromTopOfDeckToDiscard(MoveContext context, Card[] cards) {
        ...
        while (options.size() > 1) {
            int o = selectOption(context, Cards.cartographer, options.toArray(), null);
            if (o == 0) break;
    ...
    public Card scheme_actionToPutOnTopOfDeck(MoveContext context, Card[] actions) {
        ...
        for (Card c : actions)
            options.add(c);
        options.add(null);
        return options.get(selectOption(context, Cards.scheme, options.toArray(), null));
    }
    ...
    public SquireOption squire_chooseOption(MoveContext context) {
        ...
        return options[selectOption(context, Cards.squire, options, null)];
    }
    ...
    public CountFirstOption count_chooseFirstOption(MoveContext context) {
        ...
        return options[selectOption(context, Cards.count, options, null)];
    }
    ...
    public GraverobberOption graverobber_chooseOption(MoveContext context) {
        ...
        return options[selectOption(context, Cards.graverobber, options, null)];
    }
    ...
    public Card graverobber_cardToGainFromTrash(MoveContext context) {
        ...
        return options.get(selectOption(context, Cards.graverobber, options.toArray(), null));
    }
    ...
    public HuntingGroundsOption huntingGrounds_chooseOption(MoveContext context) {
        ...
        return options[selectOption(context, Cards.huntingGrounds, options, null)];
    }
    ...
    public Card mystic_cardGuess(MoveContext context, ArrayList<Card> cardList) {
        ...
        return options.get(selectOption(context, Cards.mystic, options.toArray(), null));
    }
    ...
    public Card scavenger_cardToPutBackOnDeck(MoveContext context) {
        ...
        return options.get(selectOption(context, Cards.scavenger, options.toArray(), null));
    }
    ...
    public Card rebuild_cardToPick(MoveContext context, ArrayList<Card> cardList) {
        ...
        return options.get(selectOption(context, Cards.rebuild, options.toArray(), null));
    }
    ...
    public Card rogue_cardToGain(MoveContext context) {
        ...
        return options.get(selectOption(context, Cards.rogue, options.toArray(), null));
    }

    @Override
    public Card rogue_cardToTrash(MoveContext context, ArrayList<Card> canTrash) {
        return canTrash.get(selectOption(context, Cards.rogue, canTrash.toArray(), null));
    }
    ...
    public Card pillage_opponentCardToDiscard(MoveContext context, ArrayList<Card> handCards) {
        ...
        return handCards.get(selectOption(context, Cards.pillage, options, null));
    }
    ...
    public Card hermit_cardToTrash(MoveContext context, ArrayList<Card> cardList, int nonTreasureCountInDiscard) {
        ...
        int choice = selectOption(context, Cards.hermit, options, null);
        if (choice == 0) {
            return null;
        }
    ...
    public Card knight_cardToTrash(MoveContext context, ArrayList<Card> canTrash) {
        return canTrash.get(selectOption(context, Cards.virtualKnight, canTrash.toArray(), null));
    }
