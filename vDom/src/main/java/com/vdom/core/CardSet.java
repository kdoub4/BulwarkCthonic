...
public class CardSet {
	...
	static {
		ArrayList<Card> bulwarkArpadGoblins = new ArrayList<>(Cards.heroCardsWiola);
		bulwarkArpadGoblins.addAll(Cards.woundPile);
		bulwarkArpadGoblins.addAll(Cards.locationCardsCitadelXajorkith);
		CardSetMap.put(GameType.Bulwark, new CardSet(bulwarkArpadGoblins, false));

		CardSetMap.put(GameType.Random, new CardSet(Cards.actionCards, true));
		CardSetMap.put(GameType.RandomBaseGame, new CardSet(Cards.heroCardsWiola, true));
